...
const token = "6711376093:AAEVYenN8tQ2xabx4WQWzlOZYLj2mXIwlTs";
...
bot.on("message", async (msg) => {
  ...
  try {
    const response = await axios.get(
      `https://api.openweathermap.org/data/2.5/weather?q=${userInput}&appid=74140333142d04774e5352c3c161b9aa`,
    );
